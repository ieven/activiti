...
public class SelectUsersPopupWindow extends PopupWindow {
    ...
    protected void initSelectedUsersTable() {
        ...
        selectedUsersTable.addGeneratedColumn("delete",
                new ThemeImageColumnGenerator(Images.DELETE, new com.vaadin.event.MouseEvents.ClickListener() {
                    ...
                    public void click(com.vaadin.event.MouseEvents.ClickEvent event) {
                        ...
                        if (searchFieldValue != null && searchFieldValue.length() >= 2) {
                            String userName = (String) selectedUsersTable.getItem(itemId).getItemProperty("userName")
                                    .getValue();
