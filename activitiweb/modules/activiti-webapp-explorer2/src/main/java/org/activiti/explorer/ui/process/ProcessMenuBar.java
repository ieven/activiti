...
public class ProcessMenuBar extends ToolBar {
    ...
    protected void init() {
        ...
        addToolbarEntry(ENTRY_MY_PROCESS_INSTANCES, i18nManager.getMessage(Messages.PROCESS_MENU_MY_INSTANCES),
                new ToolbarCommand() {
        ...
        addToolbarEntry(DEPLOYED_PROCESS_DEFINITIONS,
                i18nManager.getMessage(Messages.PROCESS_MENU_DEPLOYED_DEFINITIONS), new ToolbarCommand() {
        ...
        if (ExplorerApp.get().getLoggedInUser().isAdmin()) {
            addToolbarEntry(EDITOR_PROCESS_DEFINITIONS,
                    i18nManager.getMessage(Messages.PROCESS_MENU_EDITOR_DEFINITIONS), new ToolbarCommand() {
